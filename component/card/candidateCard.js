        ...
        <>
            {loading && name !== 'Search' ?
                <Spinner
                    ...
                    <Box display='flex' flexWrap='wrap' h='auto' alignItems='flex-start' w='full' >
                            ...
                            <Card className={styles.cardMain} key={card.id} width={{ base: '100%', lg: '47%' }} h='auto' my='10px' mx={2} spacing={5}>
                                <CardHeader p={0}>
                                    <Box w='100%' h='100%' display='flex' flexDirection='row' alignContent='flex-start'>
                                        ...
                                        <VStack w='50%' px={1} color='#68717A' fontSize='16px' justifyContent='space-between' alignItems='flex-start' h='170px'>
